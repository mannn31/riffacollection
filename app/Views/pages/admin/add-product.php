...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="mb-4 text-gray-800 text-center"><strong>Form Add Product</strong></h1>
                        ...
                        <div class="card-body">
                            <form action="/admin/product/save" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control <?= ($validation->hasError('nm_product')) ? 'is-invalid' : ''; ?>" id="nm_product" name="nm_product" autofocus value="<?= old('nm_product'); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="desc_product" id="desc_product" class="<?= ($validation->hasError('desc_product')) ? 'is-invalid' : ''; ?>" value="<?= old('desc_product'); ?>"> </textarea>
                                    <div class="invalid-feedback">
