...
--
-- Host: localhost:3306
-- Generation Time: Sep 19, 2022 at 03:29 AM
...
(92, '127.0.0.1', 'admin@gmail.com', 1, '2022-09-18 07:04:23', 1),
(93, '127.0.0.1', 'customer@gmail.com', 2, '2022-09-18 07:11:28', 1),
(94, '127.0.0.1', 'admin@gmail.com', 1, '2022-09-18 07:42:41', 1),
(95, '127.0.0.1', 'customer@gmail.com', 2, '2022-09-18 10:08:35', 1),
(96, '127.0.0.1', 'admin@gmail.com', 1, '2022-09-18 10:11:11', 1),
(97, '127.0.0.1', 'customer@gmail.com', 2, '2022-09-18 20:28:40', 1),
(98, '127.0.0.1', 'admin@gmail.com', 1, '2022-09-18 21:34:43', 1);
...
CREATE TABLE `orders` (
  `id` int(11) NOT NULL,
  `nm_orders` varchar(255) NOT NULL,
...
INSERT INTO `orders` (`id`, `nm_orders`, `adress`, `no_hp`, `product_id`, `qty`, `total_price`, `payment`, `img_proof`, `created_at`, `updated_at`) VALUES
(1, 'Customer', 'Cipacing', '087839736104', 2, 2, '70.000', 'BNI', 'conot-bukti.jpg', '2022-09-18 23:10:07', '2022-09-19 10:14:36');
